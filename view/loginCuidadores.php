...
<?php include('../controller/serverCuidadores.php') ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<div class="container-fluid text-center">
		<div class="row h-100">
			...
			<div class="col-lg-8" id="box">
				<form  name="login" action="loginCuidadores.php" method="post" accept-charset="utf-8">
					<fieldset>
						<div>
							...
							<div>
								<input class="btn btn-primary m-3" type="submit" name="login_cuidadores" value="Iniciar sesión" id="botonSesion">
								<a href="../index.php">
