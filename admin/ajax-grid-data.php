...
$sql.=" FROM eventos";
	...
	$sql.=" OR fechaCreacion LIKE '".$requestData['search']['value']."%' ";
	$sql.=" OR texto LIKE '".$requestData['search']['value']."%' ";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = $row["id"];
    $nestedData[] = date("d/m/Y", strtotime($row["fechaCreacion"]));
	$nestedData[] = $row["texto"];
    ...
    $nestedData[] = '<td><center>
                     ...
                     <a href="home.php?action=delete&id='.$row['id'].'"  data-toggle="tooltip" title="Eliminar" class="btn btn-sm btn-danger"> <i class="menu-icon icon-trash"></i> </a>
				     </center></td>';		
