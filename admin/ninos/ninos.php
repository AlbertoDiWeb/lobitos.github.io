...
<body>
	...
	<div class="content container-fluid">
		...
		if(isset($_GET['action']) == 'delete'){
			...
			$query = mysqli_query($conn, "SELECT * FROM ninos WHERE id='$id_delete'");
			if(mysqli_num_rows($query) == 0){
				echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
			}else{
				$delete = mysqli_query($conn, "DELETE FROM ninos WHERE id='$id_delete' LIMIT 1");
				if($delete){
					echo '<div class="alert alert-primary alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Los datos del niño han sido eliminados. Acuerdese de borrar a su tutor si fuese necesario.</div>';
				}else{
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="pull-right">
					<a href="registro.php" class="btn btn-sm btn-primary">Nuevo niño</a>
				</div><br>
				<hr>
