...
<head>
	...
	<title>Cuenta Administrador - niños</title>
...
<body>
	<nav class="navbar navbar-light bg-primary static-top">
		<div class="container-fluid">
			<div class="row">
				<a class="navbar-brand" href="tutor.php" style="font-size: 20px; margin-left: 10%;font-weight: bold;">Página principal</a>
				<?php  if (isset($_SESSION['username'])) : ?>
					<a class="btn btn-danger pull-right" style="margin-right: 5%; margin-top: 0.6%" href="../../controller/index.php?logout='1'">Desconectar</a> 
				<?php endif ?>
			</div>
		</div>
	</nav>
	<section class="text-white text-center bg-info py-2" style="padding-top: 20px; margin-top: -20px;">
		<div class="container-fluid">
      	...
      	<div class="col-lg-3 bg-info">
      		<form action="../cuidadores/homeCuidadores.php" method="post" accept-charset="utf-8">
      			<input class="btn btn-primary m-3" type="submit" name="cuidadores" value="Cuidadores">
      		<?php if (isset($_POST['cuidadores'])) {
      			header('location: ../cuidadoreshomeCuidadores.php');
      		} ?>
      		</form>
      	</div>
      	<div class="col-lg-3 bg-info">
      		<form action="../ninos/ninos.php" method="post" accept-charset="utf-8">
      	...
      	<div class="col-lg-3 bg-info">
      		<form action="../tutores/tutor.php" method="post" accept-charset="utf-8">
      			<input class="btn btn-primary m-3" type="submit" name="tutor" value="Tutores">
      		<?php if (isset($_POST['tutor'])) {
	...
	<div class="content container-fluid">
             ...
             if(isset($_GET['action']) == 'delete'){
				...
				$query = mysqli_query($conn, "SELECT * FROM tutores WHERE id='$id_delete'");
				if(mysqli_num_rows($query) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
				}else{
					$delete = mysqli_query($conn, "DELETE FROM tutores WHERE id='$id_delete' LIMIT 1");
					$deleteCuentaCuidadores = mysqli_query($conn, "DELETE FROM cuentatutores WHERE id='$id_delete' LIMIT 1 ");
					if($delete && $deleteCuentaCuidadores){
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
							<div class="pull-right">
								<a href="registro.php" class="btn btn-sm btn-primary">Nuevo Tutor</a>
							</div><br>
							<hr>
