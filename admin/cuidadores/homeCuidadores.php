...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
      	...
      	<div class="col-lg-3 bg-info">
      		<form action="homeCuidadores.php" method="post" accept-charset="utf-8">
      	...
      	<div class="col-lg-3 bg-info">
             ...
             if(isset($_GET['action']) == 'delete'){
				...
				$query = mysqli_query($conn, "SELECT * FROM cuidadores WHERE id='$id_delete'");
				if(mysqli_num_rows($query) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> No se encontraron datos.</div>';
				}else{
					$delete = mysqli_query($conn, "DELETE FROM cuidadores WHERE id='$id_delete' LIMIT 1");
					$deleteCuentaCuidadores = mysqli_query($conn, "DELETE FROM cuentacuidadores WHERE id='$id_delete' LIMIT 1 ");
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
							<div class="pull-right">
								<a href="registro.php" class="btn btn-sm btn-primary">Nuevo cuidador</a>
							</div><br>
							<hr>
